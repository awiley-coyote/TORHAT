...
TORHAT (The One Ronin Host Analysis Tool) is designed to enable the analyst to grab data necessary for host analysis on a single, or multiple host machine `n`n"
    ...
    try {
	    ...
	    if ($ADmodule -ne $null){
		    ...
		    write-host "The ActiveDirectory Module for Powershell is not installed. Without this module, you will not be able to do Active Directory scanning. If you wish to do Active Directory scanning, please install the module and restart this program`n"
        } 
    }
